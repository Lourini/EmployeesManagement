		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#louriniemployees-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"louriniemployees-display": {
								"semanticObject": "louriniemployees",
								"action": "display",
								"description": "CRUD application of Employees",
								"title": "Employees Management",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=lourini.employees",
									"url": sap.ui.require.toUrl("lourini/employees")
								}
							}
						}
					}
